...
class CodeHeatmap {
   ...
   */
  showModuleTooltip_(tooltip, moduleTime, totalTime) {
   ...
   */
  showCodeTooltip_(element, tooltip, sources, fileIndex, lineIndex, totalTime) {
   ...
   */
  hideCodeTooltip_(element, tooltip) {
